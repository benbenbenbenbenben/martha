...
var Exp = /** @class */ (function () {
    ...
    Exp.expr_assign = rule(Exp.atom, Op.anybinary, Exp.atom)
        .yields(function (y) {
        return {
            op: "binaryoperator",
            parameters: [
...
var Def = /** @class */ (function () {
    ...
    Def.methoddef = rule(optional(many(Kwrd.anyaccess, Ws.space1ton)), optional(Kwrd.static, Ws.space1ton), optional(Kwrd.async, Ws.space1ton), optional(Kwrd.atomic, Ws.space1ton), either(all(Def.returntype, Ws.space1ton, token("name", /w+/)), Kwrd.ctor), optional("(", optional(Def.argumentdefs), ")"), ":").yields(function (r, c) {
        console.log(r, c);
    });
...
var Mod = /** @class */ (function () {
    ...
    Mod.typedef = rule(Util.block(Kwrd.type, Mod.typedec), optional(Ws.ANY_WS, "is:", Ws.IND_WS, Ref.basetypename), optional(Ws.ANY_WS, "with:", Ws.IND_WS, Mod.typedef_members), optional(Ws.ANY_WS, many(Def.methoddef))).yields(function (raw, cst) {
...
var Stmt = /** @class */ (function () {
    ...
    Stmt.stmt_switch = rule("switch", Ws.space0ton, Exp.atom.yields(function (x) { return x.raw("atom"); }), ":", Stmt.stmts_case)
        .yields(function (y, h) {
        return {
            op: "switch",
            parameters: [
